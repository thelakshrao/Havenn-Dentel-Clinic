...
const MainTreatment = () => {
  ...
  const treatment = treatments.find(
    (t) => t.name.replace(/\s+/g, "-").toLowerCase() === treatmentName.toLowerCase()
  );
    ...
    <div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-20 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2">
          <h1 style={{ fontFamily: "Caveat, cursive" }} className="text-4xl font-bold mb-6 text-[#0a749b]">{treatment.name}</h1>
          <p className="text-gray-700 text-lg leading-relaxed">{treatment.desc}</p>
        </div>
